...
public static class PrototypeSceneBuilder{
 ...
 Box("Mantle Approach Platform",new Vector3(8,.09f,5),new Vector3(10,.4f,12),mantle);
 Box("Shoulder-Height Mantle Deck",new Vector3(8,.60f,14),new Vector3(14,1.42f,8),mantle);
 Box("Mantle-Slide Left Runout",new Vector3(1,.60f,14),new Vector3(8,1.42f,5),mantle);
 Box("Mantle-Slide Right Runout",new Vector3(15,.60f,14),new Vector3(8,1.42f,5),mantle);
 Box("Mantle Slide Backstop",new Vector3(8,1.55f,19),new Vector3(18,.35f,.35f),mantle);
