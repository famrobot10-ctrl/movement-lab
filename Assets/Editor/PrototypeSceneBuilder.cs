...
public static class PrototypeSceneBuilder{
 ...
 var mantle=new GameObject("03 Mantle Lab").transform;mantle.SetParent(env);Box("Mantle 0.75m",new Vector3(8,.265f,5),new Vector3(5,.75f,4),mantle);Box("Mantle 1.20m",new Vector3(8,.49f,12),new Vector3(5,1.2f,4),mantle);Box("Mantle 1.45m",new Vector3(8,.615f,20),new Vector3(5,1.45f,4),mantle);
