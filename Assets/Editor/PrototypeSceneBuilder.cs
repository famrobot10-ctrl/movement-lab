...
public static class PrototypeSceneBuilder{
 ...
 var cg=new GameObject("Main Camera");cg.tag="MainCamera";var cam=cg.AddComponent<Camera>();cam.fieldOfView=68;cg.AddComponent<AudioListener>();var follow=cg.AddComponent<ThirdPersonCamera>();follow.target=p.transform;follow.distance=2.7f;follow.pivotOffset=new Vector3(0,1.05f,0);follow.shoulderOffset=-.75f;motor.cameraTransform=cg.transform;new GameObject("Crosshair System").AddComponent<RuntimeCrosshair>();
