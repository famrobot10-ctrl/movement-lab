...
public static class PrototypeSceneBuilder{
 ...
 var cg=new GameObject("Main Camera");cg.tag="MainCamera";var cam=cg.AddComponent<Camera>();cam.fieldOfView=68;cg.AddComponent<AudioListener>();var follow=cg.AddComponent<ThirdPersonCamera>();follow.target=p.transform;follow.distance=3.15f;follow.pivotOffset=new Vector3(0,1.25f,0);follow.shoulderOffset=.85f;motor.cameraTransform=cg.transform;new GameObject("Crosshair System").AddComponent<RuntimeCrosshair>();
