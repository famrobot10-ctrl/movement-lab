...
public class MovementSettings {
 ...
 [Header("Mantle / Boost")]
 public float mantleReach=1.1f,mantleHeight=1.5f,mantleShoulderHeight=1.42f,mantleSpeed=5f,mantleDuration=.84f,mantleSlideSpeed=8f,mantleSlideDuration=.55f,mantleSlideMaxAngle=89f,mantleSlideMomentumRetention=.9f,edgeBoost=1.12f,cornerBoost=1.12f;
 [Header("Stamina")]
