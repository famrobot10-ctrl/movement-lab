...
public class MovementSettings {
 [Header("Ground")]
 public float walkSpeed=3.2f,jogSpeed=5.5f,sprintSpeed=9f,walkToSprintSeconds=2.2f,walkToSprintDistance=45f,rampResetSeconds=.35f,lateralSpeedLimit=5.5f;
