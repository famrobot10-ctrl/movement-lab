...
public class ThirdPersonCamera:MonoBehaviour{
 public Transform target; public Vector3 pivotOffset=new Vector3(0,1.35f,0); public float distance=4.5f,sensitivity=150f,minPitch=-25f,maxPitch=70f,followSharpness=16f; float yaw,pitch=18f;
